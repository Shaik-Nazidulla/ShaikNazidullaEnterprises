...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-tertiary border-t border-primary/20">
      <div ref={footerRef} className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-10 h-10 border-2 border-primary rotate-45 flex items-center justify-center">
                <span className="text-primary text-xl font-bold -rotate-45 font-display">S</span>
              </div>
              <div className="text-primary text-xs tracking-widest">
                <div className="font-display text-sm">SHAIK NAZIDULLA</div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-primary font-display text-lg mb-6">Quick Links</h3>
            <ul className="space-y-3">
              {['Home', 'About', 'Products', 'Services', 'Contact'].map((link, index) => (
                <li key={index}>
                  <a 
                    href={`#${link.toLowerCase()}`} 
                    className="text-gray-400 hover:text-primary transition-colors duration-300 text-sm inline-block hover:translate-x-2 transform"
                  >
                    {link}
                  </a>
                </li>
          ...
          {/* Products */}
          <div>
            <h3 className="text-primary font-display text-lg mb-6">Products</h3>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-primary font-display text-lg mb-6">Contact Us</h3>
